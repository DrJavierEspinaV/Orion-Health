(()=>{
  ...
  try{
    if(typeof APPS!=='undefined'&&APPS.armonizacion){
      APPS.armonizacion.src='./modules/armonizacion/index.html?v=2.1.0';
      APPS.armonizacion.desc='Aplicación clínica con motores independientes para toxina botulínica, ácido hialurónico, CaHA, PLLA, Skinbooster / mesoterapia e hilos.';
    }
