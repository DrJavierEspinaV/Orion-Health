(()=>{
  ...
  try{
    if(typeof APPS!=='undefined'&&APPS.armonizacion){
      APPS.armonizacion.src='./modules/armonizacion/index.html?v=1.8.0';
      APPS.armonizacion.desc='Aplicación clínica con motores independientes para toxina botulínica, ácido hialurónico e hidroxiapatita de calcio.';
    }
