(()=>{
  ...
  try{
    if(typeof APPS!=='undefined'&&APPS.armonizacion){
      APPS.armonizacion.src='./modules/armonizacion/index.html?v=1.6.11';
      APPS.armonizacion.desc='Aplicación clínica con atlas anatómico único, administración por mapa e informe tamaño carta.';
    }
