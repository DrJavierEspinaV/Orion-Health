(()=>{
  ...
  try{
    if(typeof APPS!=='undefined'&&APPS.armonizacion){
      APPS.armonizacion.src='./modules/armonizacion/index.html?v=1.9.0';
      APPS.armonizacion.desc='Aplicación clínica con motores independientes para toxina botulínica, ácido hialurónico, hidroxiapatita de calcio y ácido poli-L-láctico.';
    }
