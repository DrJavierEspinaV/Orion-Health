const CACHE_NAME='orion-dental-app-v1.4.4-r27';
const APP_SCOPE='./';
const SHELL=[
  ...
  './modules/armonizacion/index.html','./modules/armonizacion/registro-v145.html','./modules/armonizacion/registro-v145.css','./modules/armonizacion/registro-v145.js','./modules/armonizacion/registro-v146.html','./modules/armonizacion/registro-v147.html','./modules/armonizacion/registro-v148.html','./modules/armonizacion/registro-v149.html','./modules/armonizacion/registro-v150.html','./modules/armonizacion/anatomy-calibration-v146.css','./modules/armonizacion/anatomy-presets-v146.js','./modules/armonizacion/workflow-v147.css','./modules/armonizacion/workflow-v147.js','./modules/armonizacion/map-dynamic-v148.css','./modules/armonizacion/map-dynamic-v148.js','./modules/armonizacion/map-inline-v149.css','./modules/armonizacion/map-inline-v149.js','./modules/armonizacion/map-viewport-v150.css','./modules/armonizacion/map-viewport-v150.js','./modules/armonizacion/standalone-v151.js','./modules/armonizacion/manifest.webmanifest','./modules/armonizacion/standalone-sw.js',
  ...
  if(isArmonizacionBase){
    event.respondWith(
      fetch(request,{cache:'no-store'}).then(response=>{
        ...
        return response;
      }).catch(()=>caches.match(request).then(cached=>cached||caches.match(APP_SCOPE+'modules/armonizacion/index.html')))
    );
    return;
  }
