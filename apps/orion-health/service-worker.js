const CACHE_NAME='orion-dental-app-v1.3.5';
const APP_SCOPE='./';
const SHELL=[
  ...
  './assets/shared/clinical-audit-cmf.js','./assets/shared/clinical-audit-endo.js','./assets/shared/clinical-components-restore.js','./assets/shared/clinical-templates-cmf-v132.js','./assets/shared/clinical-output-cmf-v134.js','./assets/shared/clinical-preview-cmf-v135.js',
...
self.addEventListener('fetch',event=>{
  ...
  if(/\.(?:js|css|part|json|html)$/.test(url.pathname)){
    event.respondWith(
