const CACHE_NAME='orion-dental-app-v1.4.4-r22';
const APP_SCOPE='./';
const SHELL=[
...
self.addEventListener('fetch',event=>{
  ...
  if(isArmonizacionBase){
    event.respondWith(
      fetch(APP_SCOPE+'modules/armonizacion/registro-v148.html',{cache:'no-store'})
        .catch(()=>caches.match(APP_SCOPE+'modules/armonizacion/registro-v148.html'))
    );
    return;
  }
