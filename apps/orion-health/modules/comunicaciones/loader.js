...
setTimeout(()=>{
  try{
    ...
    loadDb_();
      ...
      .replace('</head>','<link rel="stylesheet" href="./responsive-fixes.css?v=1.3.3"></head>')
      .replace('</body>',`<script>
(function(){
...
</script><script src="../../assets/shared/session-config.js?v=1.3.3"></script><script src="../../assets/shared/communications-priority-layout.js?v=1.3.3"></script></body>`);
