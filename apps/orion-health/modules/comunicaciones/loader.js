...
setTimeout(()=>{
  try{
    ...
    loadDb_();
      ...
      .replace('</head>','<link rel="stylesheet" href="../../assets/shared/orion-identity-system-v140.css?v=1.4.2"><link rel="stylesheet" href="./responsive-fixes.css?v=1.4.2"><link rel="stylesheet" href="./mobile-v142.css?v=1.4.2"></head>')
      .replace('</body>',`<script>
(function(){
