const CACHE_NAME='orion-armonizacion-v1.6.1';
const SHELL=[
  './',
  './index.html',
  './registro-v145.html',
  ...
  './administration-only-v154.css',
  './administration-only-v154.js',
  './clinical-closure-v160.css',
  './clinical-closure-v160.js',
  './mobile-administration-v161.css',
