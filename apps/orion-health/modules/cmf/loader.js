(async()=>{
  try{
    ...
    h=h
      ...
      .replace('</body>','<script src="../../assets/shared/clinical-audit-cmf.js?v=1.3.1"></script><script src="../../assets/shared/clinical-components-restore.js?v=1.3.1"></script><script src="../../assets/shared/patient-bridge.js?v=1.3.1"></script></body>');
