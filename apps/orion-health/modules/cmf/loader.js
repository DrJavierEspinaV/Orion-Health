(async()=>{
  try{
    ...
    h=h
      ...
      .replace(/Orion — Recetas Tipo v4\.3_24 \(Interconsulta caja única\)/g,'ORION Clínico CMF — Maxilofacial PRO+ v4.3.37')
      .replace(/ORION Comunicaciones - Plataforma Clínica/g,'ORION Clínico CMF')
      .replace(/— v4\.3\.24 PRO/g,'— v4.3.37')
