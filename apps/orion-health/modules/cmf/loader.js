(async()=>{
  try{
    ...
    h=h
      ...
      .replace('</head>','<style id="mxpBrandV139">header.no-print img[alt="Maxilofacial PRO+"]{object-fit:contain}@media(max-width:700px){header.no-print img[alt="Maxilofacial PRO+"]{max-width:190px;height:72px}}</style></head>')
