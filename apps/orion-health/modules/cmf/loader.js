(async()=>{
  try{
    ...
    h=h
      ...
      .replace(/• Asistir con tiempo \(15 min\) y sin esmalte de uñas \(monitoreo\)\./g,'• IMPORTANTE: Debe presentarse con 15 minutos de anticipación a la hora programada de Pabellón Ambulatorio, para evitar retrasos en los Trámites Administrativos previos. Si no cumple con este horario, el procedimiento podrá ser reprogramado.\n• Sin esmalte de uñas si se realizará monitoreo.')
      .replace(/v_ind2\.textContent\s*=\s*indTxt;/,()=>"v_ind2.innerHTML = escapeHTML(indTxt).replace(/^(.*IMPORTANTE: Debe presentarse con 15 minutos de anticipación a la hora programada de Pabellón Ambulatorio, para evitar retrasos en los Trámites Administrativos previos\\. Si no cumple con este horario, el procedimiento podrá ser reprogramado\\.)$/m, '<strong>$1</strong>');")
