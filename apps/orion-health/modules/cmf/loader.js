(async()=>{
  try{
    ...
    h=h
      ...
      .replace('</body>','<script src="../../assets/shared/clinical-audit-cmf.js?v=1.3.2"></script><script src="../../assets/shared/clinical-templates-cmf-v132.js?v=1.3.2"></script><script src="../../assets/shared/clinical-components-restore.js?v=1.3.2"></script><script src="../../assets/shared/patient-bridge.js?v=1.3.2"></script></body>');
