(async()=>{
  try{
    ...
    h=h
      ...
      .replace('</head>','<style id="mxpBrandV138">header.no-print img[alt="Maxilofacial PRO+"]{object-fit:contain}[id^="fixedFoot"] .brand{gap:6px;align-items:center}[id^="fixedFoot"] .brand img[src*="maxilofacial-pro-plus-compact"]{max-height:54px;width:auto;object-fit:contain}[id^="fixedFoot"] .brand .by{font-size:9px;color:#64748b}@media(max-width:700px){header.no-print img[alt="Maxilofacial PRO+"]{max-width:150px;height:72px}}</style></head>')
